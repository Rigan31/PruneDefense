...
def set_default_arguments(parser):
    ...
    args.compute_cov3D_python = False # if yes, make pipeline compute covariances with Pytorch instead of author's kernels
    args.debug = False
...
def find_proxy_model(args):
    ...
    print("Finding proxy model...")
    print(args.adv_proxy_model_path)
    ...
    print(f"Proxy model path: {proxy_model_path}")
