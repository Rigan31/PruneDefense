...
from utils.pruning_defense import PruningDefense
...
def victim_training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from, exp_run):
    ...
    # defense = PruningDefense(
    #     max_gaussians=500000,
    #     soft_budget=int(500000 * 0.6),
    ...
    # FIX: was missing '/' between model_path and exp_run_
...
if __name__ == "__main__":
    ...
    # FIX: changed default from 3 to 1 -- we only need one run per experiment
